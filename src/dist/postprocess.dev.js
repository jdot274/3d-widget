...
/*#__PURE__*/
function () {
  function PostProcessor(renderer, scene, camera) {
    _classCallCheck(this, PostProcessor);

    this.renderer = renderer;
    this.scene = scene;
    this.camera = camera; // Set renderer properties for optimum transparency - match silver-3d-rectangle

    this.renderer.setClearColor(0x000000, 0);
    this.renderer.setClearAlpha(0);
    this.renderer.autoClear = false; // Optional: uncomment to enable advanced post-processing
    // this.setupComposer();
  }
  ...
  */
  ...
  _createClass(PostProcessor, [{
    ...
    key: "dispose",
    value: function dispose() {// Nothing to dispose in direct rendering mode
...
var _default = PostProcessor;
exports["default"] = _default;
//# sourceMappingURL=postprocess.dev.js.map
